...
describe('correct()', () => {
  ...
  test('многострочный текст с несколькими абзацами', () => {
    ...
    const expected =
      'ОТ РЕДАКТОРА РУССКОГО ПЕРЕВОДА\n' +
      '\n' +
      'Воспитание творческой активности учащихся в процессе изучения ими математики является одной из актуальных целей нашего школь-ного преподавания. Правильно поставленное упражнение учащихся в решении задач — основное средство для достижения указанной цели.\n' +
      '\n' +
      'Если обратиться, однако, к учебно-методической литературе по математике, будь то отечественной или иностранной, то приходится констатировать, что при наличии большого количества в своем роде весьма ценных работ, посвященных методам решения отдельных типов математических задач (арифметических, конструктивно-геомет-рических ит. д.), до сего времени фактически отсутствовали труды.\n' +
      '\n' +
      'Третий абзац\n'
  ...
  test('перенос слова на дефисе склеивается без пробела', () => {
    expect(correct('школь-\nного')).toBe('школь-ного')
    expect(correct('конструктивно-геомет-\nрических')).toBe('конструктивно-геомет-рических')
  })
