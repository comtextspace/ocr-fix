...
| 2 | Перенос слова через дефис в конце строки: `\n` убирается без пробела | `"школь-\nного"` → `"школь-ного"` |
...
```
Воспитание творческой активности учащихся в процессе изучения ими математики является одной из актуальных целей нашего школь- ного преподавания.
```
